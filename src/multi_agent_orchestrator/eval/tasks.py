...
EVAL_TASKS: list[EvalTask] = [
    ...
    EvalTask("api-inv-list-1", "How many open invoices does Meridian Supply Co have? List them.",
             ("open_invoices_ge", 1, 1), tags=["api"]),
    EvalTask("api-inv-list-2", "List the open invoices for Cobalt Systems.",
             ("open_invoices_ge", 2, 1), tags=["api"]),
    EvalTask("api-inv-list-3", "List open invoices for Vantage Health.",
             ("open_invoices_ge", 4, 1), tags=["api"]),
    EvalTask("api-inv-list-4", "List open invoices for Delta Logistics.",
    ...
    # --- API: tickets ------------------------------------------------------
    EvalTask("api-ticket-1", 'Open a support ticket for Harbor Analytics about "Overdue balance follow-up".',
             ("ticket_for", 3), tags=["api"]),
    EvalTask("api-ticket-2", 'Open a ticket for Cobalt Systems about "Integration question".',
             ("ticket_for", 2), tags=["api"]),
    EvalTask("api-ticket-3", 'Open a ticket for Vantage Health about "Renewal discussion".',
             ("ticket_for", 4), tags=["api"]),
    # --- API: set customer status -----------------------------------------
    EvalTask("api-cust-1", "Suspend Cobalt Systems's customer account via the API.",
             ("customer_status", 2, "delinquent"), tags=["api"]),
    EvalTask("api-cust-2", "Activate Vantage Health's customer account via the API.",
    ...
    EvalTask("synth-onboard-1", "Onboard Vantage Health across the console and the API.",
             [("web_status", 4, "active"), ("customer_status", 4, "active")],
             cross_system=True, expects_synth=True, tags=["synthesis", "cross"]),
    EvalTask("synth-onboard-2", "Onboard Cobalt Systems end to end.",
             [("web_status", 2, "active"), ("customer_status", 2, "active")],
             cross_system=True, expects_synth=True, tags=["synthesis", "cross"]),
    EvalTask("synth-offboard-1", "Offboard Delta Logistics across all systems.",
